package org.jikvict.jikvictbackend.problem.factory
...
class ProblemDetailFactoryTest {
    ...
    fun `should create validation problem detail`() {
        ...
        // When
        val problemDetail =
            factory.createValidationProblemDetail(
                exception = exception,
                errors = errors,
            )
    ...
    fun `should create not found problem detail`() {
        ...
        // When
        val problemDetail =
            factory.createNotFoundProblemDetail(
                exception = exception,
    ...
    fun `should create internal server error problem detail`() {
        ...
        // When
        val problemDetail =
            factory.createInternalServerErrorProblemDetail(
                exception = exception,
            )
    ...
    fun `should create custom problem detail`() {
        ...
        // When
        val problemDetail =
            factory.createCustomProblemDetail(
                exception = exception,
                type = type,
                title = title,
                status = status,
    ...
    fun `should include stack trace when configured`() {
        ...
        // When
        val problemDetail =
            factoryWithStackTrace.createProblemDetail(
                exception = exception,
        ...
        assertTrue(stackTrace.contains("at org.jikvict.jikvictbackend.problem.factory.ProblemDetailFactoryTest"))
    }
}
